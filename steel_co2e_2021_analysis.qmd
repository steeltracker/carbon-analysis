...
scope_1_and_2_emissions_2021 <- scope_1_and_2_emissions_2021_prestep %>% 
  ...
  relocate(c(eaf_capacity_tonnes_of_steel_per_year, co2e_tonnes_per_mwh, co2e_tonnes_2021, scope1_co2e_tonnes_2021, scope2_co2e_tonnes_2021), .after = region)
```
...
```{r, include=FALSE}
write_csv(scope2_plant_emissions_wide, here("output-data", "weekly_scope2_plant_emissions_2021.csv"))
```
